...
from selenium.webdriver.chrome.service import Service
s = Service('./chromedriver')  # Replace '/path/to/chromedriver' with the actual path
...
URL = 'https://mail.google.com/mail/u/0/?tab=rm&ogbl#sent/KtbxLvhZkjLcKHbwtZzfsnBGQpNWSCHKwL'
min_items = 0
curr_scan = -1
soup = None
click_time = 0.5
